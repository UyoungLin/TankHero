...
class FPWithinSurfaceBounds : public FilterPoints
{
public:
...
class FPRectangularMask : public FilterPoints
{
public:
	FPRectangularMask(int x1, int y1, int x2, int y2)
...
class FPScaling : public FilterPoints
{
public:
	FPScaling(int xStretch, int xCompress, int yStretch, int yCompress, FilterPoints* pNextFilter = nullptr)
	...
	FPScaling(int xFactor, int yFactor, FilterPoints* pNextFilter = nullptr)
...
// Filter to mask out all drawing outside of the specified region
class FPTranslation : public FilterPoints
{
public:
	FPTranslation(int xModifier, int yModifier, FilterPoints* pNextFilter = nullptr)
